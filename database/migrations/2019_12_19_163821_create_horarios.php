...
class CreateHorarios extends Migration
{
    ...
    public function up()
    {
        Schema::create('horarios', function (Blueprint $table) {
            ...
            $table->string('grupo',3)->comment('grupo');
            $table->time('horade')->comment('horario de inicio');
            $table->time('horahasta')->comment('horario hasta');
            $table->integer('idtallerista')->comment('id del usuario que es tallerista');
            $table->integer('cupo')->comment('cupo del grupo')->default(0);
            $table->integer('sesiones')->comment('numero de sesiones')->default('0');
